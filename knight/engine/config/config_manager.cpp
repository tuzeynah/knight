...
void c_config_manager::save(size_t id) const {
    ...
    j["aim_assist"] = {
        ...
        {"fov", implement::combat::aim_assist::fov},
        {"smooth", implement::combat::aim_assist::smooth},
        {"distance", implement::combat::aim_assist::distance},
        {"adaptive", implement::combat::aim_assist::adaptive},
        {"adaptive_offset", implement::combat::aim_assist::adaptive_offset},
        {"target_priority", implement::combat::aim_assist::target_priority},
    };
...
void c_config_manager::load(size_t id) {
    ...
    if (j.contains("aim_assist")) {
        ...
        implement::combat::aim_assist::fov = aa.value("fov", 35.0f);
        implement::combat::aim_assist::smooth = aa.value("smooth", 15.0f);
        implement::combat::aim_assist::distance = aa.value("distance", 4.0f);
        implement::combat::aim_assist::adaptive = aa.value("adaptive", true);
        implement::combat::aim_assist::adaptive_offset = aa.value("adaptive_offset", 3.0f);
        implement::combat::aim_assist::target_priority = aa.value("target_priority", 2);
    }
